...
const BuyOverlayCard = () => {
  return (
    <div className="fixed top-[100px] left-64  right-0 bottom-0 bg-black/40 backdrop-blur-sm w-fit h-fit z-30 flex justify-center items-center rounded-[10px] transition-all duration-1000  ">
