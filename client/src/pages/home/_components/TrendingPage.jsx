...
const TrendingPage = () => {
    ...
    return (
        <div className="w-full h-screen pl-36 py-16">
            <div>
                ...
                <Grid container spacing={12}>
                    <Grid size={5} className='flex flex-wrap gap-4'>

                        {
                            images.map((item,index) =>
                                <motion.div key={index}
                                            className='w-[243px] h-[258px] bg-[#f3e9ff] rounded-xl'
                        ...
                        <div className='w-[243px] h-[258px] rounded-xl px-6 flex flex-col items-center'>
                            <img className='w-[174px] h-[169px]' src="https://s3-alpha-sig.figma.com/img/6e96/ac48/b1e44b585512d4820850809165372def?Expires=1729468800&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=YzD2ehIKimvYBvj9Hu46HoyPCrkmtk0n6xUwTc1~OMGI6lkloJIPpF6MLqHjprxPNtrSQ0eUFj1WKPbtiF8W5Hu1iJIfhg1PDpkaTAJKvj9zySmebYmDf7D73WTus-phPA5vKeWmWbbfMXI6aM7HV6JJrHVnyDkh-v3OVD2-sKkR4nHMphIpejFw3yQeNzVaSKXXXmKPtdthrWJ9n~11fapdeUXbMDzDHbrLtV4rkED6FnVLNX~q1zlKreMQYu7oKAS9A~oKVHXRngs3a-hIJsQwx4To4Z3cIREwTNk-OYnYKWW9L6CQTEiwY6PIKnFhY~~cSEWLX-1Vh-QxzjxNZg__" alt=""/>
                    ...
                    <Grid size={7}>
                        <div className='border-2 w-[600px] h-[538px] -mt-1 rounded-xl bg-[#f3e9ff]'>
                            {
